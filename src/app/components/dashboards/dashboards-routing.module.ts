...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'dashboard-analytics', data: {breadcrumb: 'Analytics Dashboard'}, loadChildren: () => import('./analytics/analytics.dashboard.module').then(m => m.AnalyticsDashboardModule) }
    ])],
